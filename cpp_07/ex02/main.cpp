...
/*   Updated: 2021/06/15 12:46:21 by mmaj             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main( void ) {
	...
	arr_cpy = arr; // verif de l'assignation
	...
	Array <std::string>str_arr(5); // verif des strings
	...
	Array <std::string>str_arr_cpy; 		// verif copy et assignation
